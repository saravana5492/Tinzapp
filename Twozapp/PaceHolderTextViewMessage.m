...
@interface PaceHolderTextViewMessage ()

@property (nonatomic, retain) UILabel *placeHolderLabel;

@end

@implementation PaceHolderTextViewMessage
...
- (void)drawRect:(CGRect)rect
{
    if( [[self placeholder] length] > 0 )
    {
        ...
        {
            _placeHolderLabel = [[UILabel alloc] initWithFrame:CGRectMake(5,4,self.bounds.size.width - 16,0)];
