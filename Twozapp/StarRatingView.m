...
- (id)initWithFrame:(CGRect)frame andRating:(int)rating withLabel:(BOOL)label animated:(BOOL)animated
{
    ...
    if (self) {
        ...
        if (self.userRating >=20.0f) {
            //[tintLayer setBackgroundColor:[UIColor colorWithRed:255.0/255.0 green:215.0/255.0 blue:0 alpha:1.0].CGColor];
            [tintLayer setBackgroundColor:[UIColor colorWithRed:157.0/255.0 green:0 blue:33.0/255.0 alpha:1.0].CGColor];
...
{
    if (self.userRating < 20.0f) {
       // [self.tintLayer setBackgroundColor:[UIColor colorWithRed:255.0/255.0 green:215.0/255.0 blue:0 alpha:1.0].CGColor];
         [tintLayer setBackgroundColor:[UIColor colorWithRed:157.0/255.0 green:0 blue:33.0/255.0 alpha:1.0].CGColor];
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (CGRectContainsPoint(self.bounds, [[[touches allObjects]lastObject] locationInView:self])) {
        ...
        [delegate getTheRating:self.rating];
    }
}
