...
- (void) initializePageControl
{
    ...
    UIView *pageBack = [[UIView alloc] initWithFrame:CGRectMake(0,
                                                                _scrollView.frame.size.height - 55,
                                                                _scrollView.frame.size.width,
                                                                55)];
    pageBack.backgroundColor = [UIColor blackColor];
    pageBack.alpha = 1.0f;
    pageBack.layer.cornerRadius = 0.0f;
    
    [self addSubview:pageBack];

    CGRect pageControlFrame = CGRectMake(0, 0, _scrollView.frame.size.width, kPageControlHeight);
    _pageControl = [[UIPageControl alloc] initWithFrame:pageControlFrame];
    _pageControl.center = CGPointMake(_scrollView.frame.size.width / 2, _scrollView.frame.size.height - 25.0);
...
{
    _imageCounterBackground = [[UIView alloc] initWithFrame:CGRectMake(0,
                                                                       _scrollView.frame.size.height - 55,
                                                                       _scrollView.frame.size.width,
                                                                       55)];
